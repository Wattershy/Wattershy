Use the following 11 text examples to format them to "large heading", "paragraph", "medium heading", "italic" etc as explained in the text into Markdown language.
